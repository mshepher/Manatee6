...
namespace Manatee7 {
  public partial class JoinGamePage : Rg.Plugins.Popup.Pages.PopupPage {
    ...
    public JoinGamePage(Invitation invite) {
      ...
      //controller.VisibleInvitations.CollectionChanged += Cancelled;
    ...
    private async void Cancelled(object sender, EventArgs e) {
      ...
      //if another game was cancelled, we don't care.  However, if one of two overlapping invites from
      //the same host disappeared, we also don't care.
